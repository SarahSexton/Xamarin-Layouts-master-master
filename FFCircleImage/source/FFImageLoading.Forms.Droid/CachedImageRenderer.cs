...
namespace FFImageLoading.Forms.Droid
{
	...
	public class CachedImageRenderer : ViewRenderer<CachedImage, CachedImageView>
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == CachedImage.BorderColorProperty.PropertyName ||
		...
		protected override bool DrawChild(Canvas canvas, Android.Views.View child, long drawingTime)
		{
			if (((CachedImage)Element).IsCircleImage)
				try
				{
					...
					var borderThickness = (float)((CachedImage)Element).BorderThickness;
					...
					paint.Color = ((CachedImage)Element).FillColor.ToAndroid();
					...
					if (strokeWidth > 0.0f)
					{
						...
						paint.Color = ((CachedImage)Element).BorderColor.ToAndroid();
						canvas.DrawPath(path, paint);
						paint.Dispose();
					}
